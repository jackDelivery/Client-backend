...
const { register, VerifyOtp, createLicinece, createCinic, createPdf, ForgetPassword, ResetPassword, login, CreateAge, AdminApproved } = require("../Controller/cycoController");
...
router.route("/cyco/login/approved").put(CycoauthMiddleware, isAdmin, AdminApproved);
